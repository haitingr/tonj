...
import org.tron.trident.crypto.SECP256K1.PrivateKey;
...
public class KeyPair {
    ...
    public static void main(String[] args)throws Exception{
    	PrivateKey key=PrivateKey.create("7e229a75c53499a7cbe27eff3c7bfe4a1f0d524aea1fc79b44a9705f2aa3e059");
    	PublicKey pk=PublicKey.create(key);
    	System.out.println(pk);
    	System.out.println(publicKeyToBase58CheckAddress(pk));
